interface IEmailFromContactForm {
  name: string;
  email: string;
  subject: string;
  message: string;
...
export const emailFromContactForm = (props: IEmailFromContactForm) => {
  const html = `
        ...
        <tbody>
          <tr>
            <td>
              ...
              <p style="font-size:14px;line-height:22px;margin:16px 0;color:#fff">Olá, ${props.toName}!</p>
        ...
        <tbody>
          <tr>
            <td style="padding:16px 40px; margin:40px">
              <p style="font-size:14px;line-height:22px;margin:16px 0;color:#fff"><strong>Nome:</strong> ${props.name}</p>
              <p style="font-size:14px;line-height:22px;margin:16px 0;color:#fff"><strong>E-mail:</strong> ${props.email}</p>
              <p style="font-size:14px;line-height:22px;margin:16px 0;color:#fff"><strong>Assunto:</strong> ${props.subject}</p>
              <p style="font-size:14px;line-height:22px;margin:16px 0;color:#fff"><strong>Mensagem:</strong> ${props.message}</p>
            </td>
          </tr>
        </tbody>
      </table>
